...
//
//        let geofenceLocation = CLLocation(latitude: 40.83460879, longitude: 14.359288)
//        let geofenceLocation2 = CLLocation(latitude: 40.828294, longitude: 14.364892)
//        let geofenceLocation3 = CLLocation(latitude: 40.843741, longitude: 14.367596)
//        let casa = CLLocation(latitude: 40.82834449983451, longitude: 14.364611082249596)
//        let gabriele = CLLocation(latitude: 40.84549481806883, longitude: 14.357071398924063)
//        let tragitto1 = CLLocation(latitude: 40.81825146126792, longitude: 14.331597094190698)
//        let tragitto2 = CLLocation(latitude: 40.83640898234208, longitude: 14.302314384341173)
//        let tragitto3 = CLLocation(latitude: 40.84584351226695, longitude: 14.266036488355923)
//        let tragitto4 = CLLocation(latitude: 40.83161996004151, longitude: 14.239625360087985)
//        let tragitto5 = CLLocation(latitude: 40.823419768266774, longitude: 14.216059507482782)
//
//
//
//        geofenceLocations.append(geofenceLocation)
//        geofenceLocations.append(geofenceLocation2)
//        geofenceLocations.append(geofenceLocation3)
//        geofenceLocations.append(casa)
//        geofenceLocations.append(gabriele)
//        geofenceLocations.append(tragitto1)
//        geofenceLocations.append(tragitto2)
//        geofenceLocations.append(tragitto3)
//        geofenceLocations.append(tragitto4)
//        geofenceLocations.append(tragitto5)
//
//
//
//    }
...
struct geo: View {
    ...
    var body: some View {
        VStack {
            Text(locationManager.isInsideGeofence ? "Sei vicino a una delle coordinate di geofencing!" : "Non sei vicino a nessuna delle coordinate di geofencing.")
                .font(.title)
                .padding()
...
//            }) {
//                Text(isMonitoringStarted ? "Smetti di monitorare la posizione" : "Inizia il monitoraggio delle coordinate")
//            }
            .padding()
        }
    }
